        ...
        play(){
            ...
            Player.getPlayerInfo();
             ...
             if (frameCount % 80 === 0) {
                 ...
                 switch(rand){
                     ...
                     case 1: losing.addImage("stone",stone1_img);
                     break;
             ...
             if (frameCount % 100 === 0) {
                gameOver = createSprite(random(100, 1000), 0, 100, 100);
                gameOver.velocityY = 6+player.score/10;
                var rand = Math.round(random(1));
                switch(rand){
                    
                    case 1: gameOver.addImage("bomb",bomb1_img);
                    break;
                   
                }
                EndGroup.add(gameOver);
             ...
             if (frameCount % 20 === 0) {
                ...
                switch(rand){
                    ...
                    break;
                    case 3: scoring.addImage("coins",coin1_img);
                    break;
            ...
            if (player.index !== null) {
                for(var i = 0; i< EndGroup.length;i++){
                    if(EndGroup.get(i).isTouching(players)){
                    
                      EndGroup.get(i).destroy();
                      player.score =player.score-3;
                      player.update();
                    }
